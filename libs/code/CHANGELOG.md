...
## [0.1.22](https://github.com/navono/deepagents/compare/deepagents-code==0.1.21...deepagents-code==0.1.22) (2026-06-24)


### Features

* **code:** `--timeout` flag for non-interactive ([#3351](https://github.com/navono/deepagents/issues/3351)) ([44e86ab](https://github.com/navono/deepagents/commit/44e86abbb1870f689dace8b1be6ed430d65e74c1))
* **code:** `/install` optional extras ([#3606](https://github.com/navono/deepagents/issues/3606)) ([7ffaa93](https://github.com/navono/deepagents/commit/7ffaa93dca6910cd454040d416ff7e0e8bcbcea5))
* **code:** `/model` toggle for recommended-only list ([#3453](https://github.com/navono/deepagents/issues/3453)) ([c326b7e](https://github.com/navono/deepagents/commit/c326b7ec1b9940861175e0466ab4221f03e2bcba))
* **code:** `/restart` hidden slash command ([#3514](https://github.com/navono/deepagents/issues/3514)) ([74bdd36](https://github.com/navono/deepagents/commit/74bdd3688948d8369cdd978590f5a822eabeb12c))
* **code:** `dcode doctor` diagnostics command ([#4148](https://github.com/navono/deepagents/issues/4148)) ([8179731](https://github.com/navono/deepagents/commit/81797312c7d857e7d94d03c9c695cd3c8d88799a))
* **code:** `dcode mcp config` and unify `--mcp-config` flag ([#3541](https://github.com/navono/deepagents/issues/3541)) ([f037b14](https://github.com/navono/deepagents/commit/f037b140f90a1ba3725b3ef23ab385b3cafe223b))
* **code:** add `--sandbox-snapshot-name` flag ([#3538](https://github.com/navono/deepagents/issues/3538)) ([b01392e](https://github.com/navono/deepagents/commit/b01392e7549798434f27f3784fa8c4e734053787))
* **code:** add `get_current_thread_id` tool ([#3820](https://github.com/navono/deepagents/issues/3820)) ([18ce094](https://github.com/navono/deepagents/commit/18ce094b7036796c7e23ce1338f4da56dc2ef126))
* **code:** add agent filter dropdown to `/threads` picker ([#3677](https://github.com/navono/deepagents/issues/3677)) ([f8193df](https://github.com/navono/deepagents/commit/f8193df41d7c47626d94252039217f4079d117cd))
* **code:** add config command and canonical config manifest ([#3763](https://github.com/navono/deepagents/issues/3763)) ([79899a3](https://github.com/navono/deepagents/commit/79899a306d01de6217a1dfcc013ae92c808a47a0))
* **code:** add Deep Agents client version metadata ([#3934](https://github.com/navono/deepagents/issues/3934)) ([058cec6](https://github.com/navono/deepagents/commit/058cec654645dd1a504408d712ab678edc48273d))
* **code:** add latest frontier models to recommended list ([#4045](https://github.com/navono/deepagents/issues/4045)) ([1145356](https://github.com/navono/deepagents/commit/114535637eaee383c64eac5282bc9ac57007c83f))
* **code:** add macOS keyboard shortcuts for line navigation ([#3575](https://github.com/navono/deepagents/issues/3575)) ([2a3031d](https://github.com/navono/deepagents/commit/2a3031d7846572f91face567ffdd8976b9dda64d))
* **code:** add MCP error detail modal ([#3687](https://github.com/navono/deepagents/issues/3687)) ([4ae4754](https://github.com/navono/deepagents/commit/4ae475453ce0df6d6b057b7e163396aa27d55143))
* **code:** add pre-release update support ([#3960](https://github.com/navono/deepagents/issues/3960)) ([341a5cc](https://github.com/navono/deepagents/commit/341a5cc55a30d808dbb366b396923c7801c431d2))
* **code:** add provider-specific auth guidance ([#4004](https://github.com/navono/deepagents/issues/4004)) ([6a39247](https://github.com/navono/deepagents/commit/6a392471ba30089b1a63135494873d55209bb081))
* **code:** add structured TUI display for `js_eval` ([#4151](https://github.com/navono/deepagents/issues/4151)) ([91c0dae](https://github.com/navono/deepagents/commit/91c0dae3fe0253f02a5926fcd3c6f796cd8d11fe))
* **code:** add toggleable message timestamp footers ([#3662](https://github.com/navono/deepagents/issues/3662)) ([977e110](https://github.com/navono/deepagents/commit/977e11006cfbd78fbaba4e7bb2a13acf6b788652))
* **code:** allow dependency updates without requiring release ([#4157](https://github.com/navono/deepagents/issues/4157)) ([7beb97a](https://github.com/navono/deepagents/commit/7beb97a2b02e2fd238baf3b6f05d43a4accf3f42))
* **code:** auto-install ripgrep on first run ([#3348](https://github.com/navono/deepagents/issues/3348)) ([fecf22b](https://github.com/navono/deepagents/commit/fecf22b0909e79ff7bdf180baf20abf5fdf1f390))
* **code:** auto-retry credentials-blocked startup after `/auth` ([#4176](https://github.com/navono/deepagents/issues/4176)) ([d10ba3d](https://github.com/navono/deepagents/commit/d10ba3dc162e47cc71df56b8e3d0000b6e0ed847))
* **code:** browser loopback OAuth callback for MCP auth ([#3467](https://github.com/navono/deepagents/issues/3467)) ([d83aa07](https://github.com/navono/deepagents/commit/d83aa07c818af35800f81d062a147fa45a47ace7))
* **code:** ChatGPT OAuth sign-in for Codex models ([#3532](https://github.com/navono/deepagents/issues/3532)) ([202e0bd](https://github.com/navono/deepagents/commit/202e0bd3e5b8b874a69656815489308d75a77d05))
* **code:** clarify install-script messaging for editable installs ([#3600](https://github.com/navono/deepagents/issues/3600)) ([5e4306f](https://github.com/navono/deepagents/commit/5e4306feed530e2b3bdc081ba703b591cbc53eac))
* **code:** clear chat input via `esc+esc`, add `[ X ]/[ COPY ]` buttons ([#4000](https://github.com/navono/deepagents/issues/4000)) ([c20546f](https://github.com/navono/deepagents/commit/c20546feac7876786e6816776d1ccfa5fcd4b2c8))
* **code:** confirm "Launched" after auto-update restart ([#4098](https://github.com/navono/deepagents/issues/4098)) ([df8db8a](https://github.com/navono/deepagents/commit/df8db8af6a7cbfc2ab535020b951d73759da73dd))
* **code:** confirm modal for `/install --package` ([#3840](https://github.com/navono/deepagents/issues/3840)) ([3d75026](https://github.com/navono/deepagents/commit/3d75026e2f241648fae78d9e1de2cbb4985f58ff))
* **code:** copy focused input selection on `Ctrl+C` ([#3841](https://github.com/navono/deepagents/issues/3841)) ([99f782c](https://github.com/navono/deepagents/commit/99f782cf08336c200d02a24ae4edaa650af67ed2))
* **code:** disable MCP servers from TUI ([#3501](https://github.com/navono/deepagents/issues/3501)) ([5725de8](https://github.com/navono/deepagents/commit/5725de857722dbca768a95bc6d97af5b838a11a9))
* **code:** dual-write agent traces to extra LangSmith projects ([#3998](https://github.com/navono/deepagents/issues/3998)) ([1b94cf3](https://github.com/navono/deepagents/commit/1b94cf322949e0cafd6f2bacf343fb0044ec5a8c))
* **code:** first-class `[retries]` config ([#3772](https://github.com/navono/deepagents/issues/3772)) ([9334d91](https://github.com/navono/deepagents/commit/9334d91ef94997e46d5373daca9c146fa9498763))
* **code:** float unauthorized MCP servers to top and prompt before reconnect ([#3493](https://github.com/navono/deepagents/issues/3493)) ([2d66580](https://github.com/navono/deepagents/commit/2d665804131961dfa7e2849248047deec818e4ef))
* **code:** guard managed onboarding-name memory block from edits ([#3822](https://github.com/navono/deepagents/issues/3822)) ([dc0a51f](https://github.com/navono/deepagents/commit/dc0a51fc81d01b62dc8043148a9fd87099fc9123))
* **code:** in-TUI MCP OAuth login with auto-refresh ([#3469](https://github.com/navono/deepagents/issues/3469)) ([20e38b8](https://github.com/navono/deepagents/commit/20e38b8ebd8d9aa4697334432f7832a0a07aea3a))
* **code:** JS interpreter middleware via `langchain-quickjs` ([#3525](https://github.com/navono/deepagents/issues/3525)) ([f0ca89c](https://github.com/navono/deepagents/commit/f0ca89c962c22058194121526638bc2d29f546bd))
* **code:** list valid extras when `/install` has no argument ([#3695](https://github.com/navono/deepagents/issues/3695)) ([c7d529c](https://github.com/navono/deepagents/commit/c7d529ca0fc478dec9060ea04bcc8589f9b1cd3a))
* **code:** make auto-update opt-out by default ([#3994](https://github.com/navono/deepagents/issues/3994)) ([7ff6e22](https://github.com/navono/deepagents/commit/7ff6e2224d7ba8462c073333da937c35831f9b34))
* **code:** manage Tavily web-search API key in `/auth` ([#4062](https://github.com/navono/deepagents/issues/4062)) ([90cc099](https://github.com/navono/deepagents/commit/90cc099b0998a9aa55df01e3bc12ad1597c65365))
* **code:** MCP screen metadata ([#3349](https://github.com/navono/deepagents/issues/3349)) ([ce2f07e](https://github.com/navono/deepagents/commit/ce2f07e7211f22b3f44a1a232088b89a469a0a99))
* **code:** non-interactive `deepagents auth` subcommands ([#3910](https://github.com/navono/deepagents/issues/3910)) ([11a71bb](https://github.com/navono/deepagents/commit/11a71bbf00c4e6c1f989e70fb3472a65c8d39662))
* **code:** note minimum OpenAI key permissions in `/auth` ([#4040](https://github.com/navono/deepagents/issues/4040)) ([14be63d](https://github.com/navono/deepagents/commit/14be63d476ed8dece75e20fff05016122c258be8))
* **code:** offer restart after restart-capable install ([#3821](https://github.com/navono/deepagents/issues/3821)) ([e356efe](https://github.com/navono/deepagents/commit/e356efeff1c8bfb894119cebbb7d3c0853d327a2))
* **code:** pair model API keys with their endpoints ([#3770](https://github.com/navono/deepagents/issues/3770)) ([cf98030](https://github.com/navono/deepagents/commit/cf9803072dc0fdc1d5850c9fd2fc4eb6893ed8c9))
* **code:** persist `/threads` directory-scope preference ([#3824](https://github.com/navono/deepagents/issues/3824)) ([51a29f4](https://github.com/navono/deepagents/commit/51a29f4a0c28c122acae296a0df03bee20474455))
* **code:** pluggable third-party sandbox backends ([#3842](https://github.com/navono/deepagents/issues/3842)) ([2b635a7](https://github.com/navono/deepagents/commit/2b635a7e6e6b50ca8ce783c2ac96ed8643ae0224))
* **code:** prompt before updating an out-of-date dcode install ([#3995](https://github.com/navono/deepagents/issues/3995)) ([a5ec6dd](https://github.com/navono/deepagents/commit/a5ec6dd0fec66ad321c1cc0f5e2f990c9026e03f))
* **code:** prompt to install provider when selecting an uninstalled model ([#3981](https://github.com/navono/deepagents/issues/3981)) ([619207c](https://github.com/navono/deepagents/commit/619207c8d4d4308a9a3ab9d2d039506feeaf8a67))
* **code:** quiet install script's full dependency list ([#4058](https://github.com/navono/deepagents/issues/4058)) ([de2c9fd](https://github.com/navono/deepagents/commit/de2c9fd8c7437fdcdfe738599f83808c5423c55c))
* **code:** show connection state in the status bar ([#3710](https://github.com/navono/deepagents/issues/3710)) ([3e3e8fe](https://github.com/navono/deepagents/commit/3e3e8feb0e6e1b77be75a7756fbf32e5c9497c28))
* **code:** show provider in usage stats table ([#4049](https://github.com/navono/deepagents/issues/4049)) ([309b054](https://github.com/navono/deepagents/commit/309b054fdd040adb5086408a3bcb2550ba73439e))
* **code:** surface deferred MCP reconnect state in `/mcp` ([#3612](https://github.com/navono/deepagents/issues/3612)) ([d8205c2](https://github.com/navono/deepagents/commit/d8205c2a39d00e8b6f7f70afe7cc9bb92fee42d8))
* **code:** surface editable mode and core deps in `/version` ([#3898](https://github.com/navono/deepagents/issues/3898)) ([d4f5a12](https://github.com/navono/deepagents/commit/d4f5a12cc6d73dc19d24d5748242705d79fa65bf))
* **code:** surface gateway key mismatch on `PermissionDeniedError` ([#3813](https://github.com/navono/deepagents/issues/3813)) ([5bd1ef8](https://github.com/navono/deepagents/commit/5bd1ef8cb29db781ccbb37755db44ce0ab1d7bd2))
* **code:** surface LangSmith tracing projects in `LocalContextMiddleware` ([#3836](https://github.com/navono/deepagents/issues/3836)) ([676abec](https://github.com/navono/deepagents/commit/676abecf892ff537fcb1425ba5929cace3c5d503))
* **code:** surface MCP servers awaiting reconnect on splash banner ([#3615](https://github.com/navono/deepagents/issues/3615)) ([24c5258](https://github.com/navono/deepagents/commit/24c5258ae6664bc3d3875d8065038716f7c86161))
* **code:** surface tracing in `doctor` and `config show` ([#4163](https://github.com/navono/deepagents/issues/4163)) ([2bb3e44](https://github.com/navono/deepagents/commit/2bb3e44243553a5f2954a0f3ec42364563842a87))
* **code:** surface uninstalled known providers in `/auth` menu ([#4059](https://github.com/navono/deepagents/issues/4059)) ([73db271](https://github.com/navono/deepagents/commit/73db2719bce5ad3c933ffee643df4a62cfd60e17))
* **code:** warn on `--interpreter-tools` without `--interpreter` ([#3976](https://github.com/navono/deepagents/issues/3976)) ([e68e720](https://github.com/navono/deepagents/commit/e68e720e2c3caa4e4e7c5e937faf718db7ad2e98))
* **code:** word-level double-click selection ([#3740](https://github.com/navono/deepagents/issues/3740)) ([4bb4286](https://github.com/navono/deepagents/commit/4bb4286a26c9c9bc69a36f2714d9eb0e3e5e4d40))
* **runloop:** add blueprint bootstrapping for Runloop sandboxes ([#3556](https://github.com/navono/deepagents/issues/3556)) ([13dafd8](https://github.com/navono/deepagents/commit/13dafd8823c4b530c8e096012733ad74cd501b59))
* **sdk:** surface subagents via inherited `lc_agent_name` projection ([e0a1ed2](https://github.com/navono/deepagents/commit/e0a1ed24e6b44c31d0aac3358aeee0d6cb66b2c4))
* **talon:** add local runtime host ([#3759](https://github.com/navono/deepagents/issues/3759)) ([7358a66](https://github.com/navono/deepagents/commit/7358a6663b1b2cda42392616eb04d39d01f42b2b))
* **vercel:** add Vercel Sandbox provider ([#3588](https://github.com/navono/deepagents/issues/3588)) ([e5e4748](https://github.com/navono/deepagents/commit/e5e4748cb6c66ddaa9444ab464990c1a5d10854d))


### Bug Fixes

* **code:** add debug-log guidance for truncated startup errors ([#3849](https://github.com/navono/deepagents/issues/3849)) ([cd1ef30](https://github.com/navono/deepagents/commit/cd1ef303cf5d0e9d746c787eb09a4a89437e965a))
* **code:** add terminal progress preference ([#3728](https://github.com/navono/deepagents/issues/3728)) ([d9e4976](https://github.com/navono/deepagents/commit/d9e4976826ae2281e90e06facb5a70a785703029))
* **code:** agent retries `gh search` with invalid `mergedAt` field ([#3802](https://github.com/navono/deepagents/issues/3802)) ([0b683a9](https://github.com/navono/deepagents/commit/0b683a9435b95bce79d10451868eae54c6a3e88c))
* **code:** allow recovery commands when startup fails ([#3706](https://github.com/navono/deepagents/issues/3706)) ([727d022](https://github.com/navono/deepagents/commit/727d022cd1526836c3d1de997c1f036e870881f7))
* **code:** cancel server-side runs before re-trying interrupted-state writes ([#3611](https://github.com/navono/deepagents/issues/3611)) ([7d46357](https://github.com/navono/deepagents/commit/7d46357c5446bbc6225f972fd66dc52af8dd0547))
* **code:** centralize debug logging setup to package root ([#3650](https://github.com/navono/deepagents/issues/3650)) ([5145ed1](https://github.com/navono/deepagents/commit/5145ed1f8296f41d78c905c2ce899d2742f7dc9b))
* **code:** char-truncate execute tool preview output ([#3627](https://github.com/navono/deepagents/issues/3627)) ([bb276e2](https://github.com/navono/deepagents/commit/bb276e2c41177b0dfe6ffd44fd37a293fbfdcb27))
* **code:** chat input history navigation and newline scrolling ([#3560](https://github.com/navono/deepagents/issues/3560)) ([3b51cbd](https://github.com/navono/deepagents/commit/3b51cbdc8c50d9990477e18a47de6a58e9165bab))
* **code:** clarify `/restart` message during server startup ([#3823](https://github.com/navono/deepagents/issues/3823)) ([49ded9e](https://github.com/navono/deepagents/commit/49ded9ef448dcd263bee07ac15f4904dd342bfa2))
* **code:** clarify post-update restart semantics ([6318b81](https://github.com/navono/deepagents/commit/6318b817399f7dd2f2e6dc07987dca46f1da9886))
* **code:** coalesce streamed markdown writes to keep input responsive ([#3819](https://github.com/navono/deepagents/issues/3819)) ([b45eeeb](https://github.com/navono/deepagents/commit/b45eeebaf7e6ae6e07b8f9ca521525c66fe14f63))
* **code:** cursor at end when popping queued message to input ([#3832](https://github.com/navono/deepagents/issues/3832)) ([aa522c9](https://github.com/navono/deepagents/commit/aa522c94fffb93dc578addb39b4879f779ac5899))
* **code:** distinguish LangSmith failure modes in `/trace` ([#3558](https://github.com/navono/deepagents/issues/3558)) ([4d158a0](https://github.com/navono/deepagents/commit/4d158a031aecad8862e02e332f127573003938ec))
* **code:** don't move cursor on click that re-focuses terminal ([#3893](https://github.com/navono/deepagents/issues/3893)) ([b76788b](https://github.com/navono/deepagents/commit/b76788b7850e910fe2882cb1a62ffff6ff5085b0))
* **code:** don't show `"No threads found"` while threads load ([#3815](https://github.com/navono/deepagents/issues/3815)) ([68e6426](https://github.com/navono/deepagents/commit/68e64263f590b3244b689664715f354fb3a389cd))
* **code:** drop lock-key events so Caps Lock in iTerm2 doesn't type ([#3855](https://github.com/navono/deepagents/issues/3855)) ([110f1a7](https://github.com/navono/deepagents/commit/110f1a7a975743efda12e181cb3afc8404202254))
* **code:** editable-install guidance for adding extras ([#3610](https://github.com/navono/deepagents/issues/3610)) ([771e55f](https://github.com/navono/deepagents/commit/771e55f171b8087b876ecf767d2f23c86c2a27b9))
* **code:** exclude managed bin dir from agent picker ([#4190](https://github.com/navono/deepagents/issues/4190)) ([d869d1e](https://github.com/navono/deepagents/commit/d869d1e1fa8558510fb48e71f78fb74c69ca4840))
* **code:** exclude prompt prefix from `UserMessage` selection ([#4002](https://github.com/navono/deepagents/issues/4002)) ([8ee6ba6](https://github.com/navono/deepagents/commit/8ee6ba6e64895d3d36a5957627221ed7667bc1d4))
* **code:** expose `/restart` slash command ([#3809](https://github.com/navono/deepagents/issues/3809)) ([64505b8](https://github.com/navono/deepagents/commit/64505b848868b80213b6da87113cd63890c3d520))
* **code:** fix zero tool MCP server rendering ([#3649](https://github.com/navono/deepagents/issues/3649)) ([7e7a567](https://github.com/navono/deepagents/commit/7e7a567556110ad927a78b45c3a3d4ac37b65e86))
* **code:** generic "missing credentials" in model switcher ([#4182](https://github.com/navono/deepagents/issues/4182)) ([456ce5c](https://github.com/navono/deepagents/commit/456ce5c2f5487a754d1fea7046e32c03b7e27a17))
* **code:** guard against misconfigured LangSmith tracing ([#3993](https://github.com/navono/deepagents/issues/3993)) ([81acc2e](https://github.com/navono/deepagents/commit/81acc2ecdada55a98e512f96b0caf8cb0f2c6d29))
* **code:** guard pasted-path probes against `OSError` ([#3745](https://github.com/navono/deepagents/issues/3745)) ([c9617d3](https://github.com/navono/deepagents/commit/c9617d3594ab1448c4f3ee2212cdc66cbf138b77))
* **code:** guard restart-prompt import against in-place self-upgrade ([#3980](https://github.com/navono/deepagents/issues/3980)) ([7af13f6](https://github.com/navono/deepagents/commit/7af13f6ec2440c2e3eb63bad2ff31e809f772804))
* **code:** hand pointer over splash tracing project link ([#3858](https://github.com/navono/deepagents/issues/3858)) ([ea7dae5](https://github.com/navono/deepagents/commit/ea7dae58a37cfb1d2b96544eb7c941aad331b280))
* **code:** handle LangSmith project-not-found and default tracing project ([#4153](https://github.com/navono/deepagents/issues/4153)) ([e303ce9](https://github.com/navono/deepagents/commit/e303ce986a3595f0cf458e796d857f7c8f5f8b5c))
* **code:** handle MCP tool errors locally ([#3830](https://github.com/navono/deepagents/issues/3830)) ([97a7052](https://github.com/navono/deepagents/commit/97a7052b3eef7ec80bc90a4c3b606deeaf13cb9b))
* **code:** handle stale slash-command `Enter` before completion popup renders ([#3647](https://github.com/navono/deepagents/issues/3647)) ([9a28742](https://github.com/navono/deepagents/commit/9a287424e86d5d52d0a328388c3fe453b160f597))
* **code:** hide `[SYSTEM]` interrupt notices from `/threads` prompt ([#3988](https://github.com/navono/deepagents/issues/3988)) ([68fa0cb](https://github.com/navono/deepagents/commit/68fa0cb4d48ff3f3e552bbf16f8316433c7b6f34))
* **code:** hide chat input action buttons in same frame as empty draft ([#4178](https://github.com/navono/deepagents/issues/4178)) ([f94d417](https://github.com/navono/deepagents/commit/f94d417d5ad9928db967777fe1d7bc2c37684fb9))
* **code:** ignore stale cwd warmers in file autocomplete cache ([#3835](https://github.com/navono/deepagents/issues/3835)) ([9c8c2b2](https://github.com/navono/deepagents/commit/9c8c2b24853b7b3a7610cbcfc368a6464c0711e0))
* **code:** install script binary checks reference `dcode` ([#3546](https://github.com/navono/deepagents/issues/3546)) ([f8977a6](https://github.com/navono/deepagents/commit/f8977a63769e3f2037619f32596cb9bb7bd1020b))
* **code:** join aiosqlite worker thread after close ([#3585](https://github.com/navono/deepagents/issues/3585)) ([152cec0](https://github.com/navono/deepagents/commit/152cec04affed3508d4bfdffe7cae522b16d45e6))
* **code:** keep auth modal interactive after install-on-select ([#4187](https://github.com/navono/deepagents/issues/4187)) ([afbc56a](https://github.com/navono/deepagents/commit/afbc56a1d9dbe8a89015f4c2f90bb87547d5c1d4))
* **code:** keep chat input focused when clicking a message ([#3655](https://github.com/navono/deepagents/issues/3655)) ([daf6571](https://github.com/navono/deepagents/commit/daf65716d7c999eadb2b7c37e412ec07b2c7aed3))
* **code:** keep install-required `/model` rows dimmed after navigation ([#4048](https://github.com/navono/deepagents/issues/4048)) ([c499634](https://github.com/navono/deepagents/commit/c499634c530dcab9b18e3126b4573ff0d36c3efa))
* **code:** keep startup import prewarm from crashing the TUI mid-upgrade ([#3756](https://github.com/navono/deepagents/issues/3756)) ([867a2e5](https://github.com/navono/deepagents/commit/867a2e5c341bd9dfa70b47c7fafc194ac51d7469))
* **code:** keep terminal-default theme on Esc in `/theme` selector ([#3854](https://github.com/navono/deepagents/issues/3854)) ([c3bc67b](https://github.com/navono/deepagents/commit/c3bc67b0cdeda6f4dbcc6360ddd72b455aec4fe7))
* **code:** label `-r` resume as `"Resuming..."` in the status bar ([#3892](https://github.com/navono/deepagents/issues/3892)) ([70cd286](https://github.com/navono/deepagents/commit/70cd28643bc2ca7da5a61a7b7203c6de2266ca4e))
* **code:** make `/timestamps` toggle instant via per-footer class ([#4095](https://github.com/navono/deepagents/issues/4095)) ([7ae32b0](https://github.com/navono/deepagents/commit/7ae32b0a606cc200d4311e11036a65f17e8282b3))
* **code:** make non-incognito `!` shell output visible to the model ([#3825](https://github.com/navono/deepagents/issues/3825)) ([2407bca](https://github.com/navono/deepagents/commit/2407bca66bac5d199a923a0e58872c813eb006bc))
* **code:** mention `Ctrl+R` in MCP reconnect toast ([#3622](https://github.com/navono/deepagents/issues/3622)) ([3b4b086](https://github.com/navono/deepagents/commit/3b4b0867665e58959073e660d85b74c700acaa1e))
* **code:** move MCP trust state out of user config ([#3742](https://github.com/navono/deepagents/issues/3742)) ([a97f2fd](https://github.com/navono/deepagents/commit/a97f2fd394e6b0b943225a0195b0901188bd368c))
* **code:** normalize empty file list tool output ([#3697](https://github.com/navono/deepagents/issues/3697)) ([b67aead](https://github.com/navono/deepagents/commit/b67aead2b86e04aaee8f2dbfba7b263e3e23597d))
* **code:** offer cwd switch on resume ([#3810](https://github.com/navono/deepagents/issues/3810)) ([d417f53](https://github.com/navono/deepagents/commit/d417f530aafa8c77523487393dc3039cc822dc09))
* **code:** pause loading timer during approvals ([#3782](https://github.com/navono/deepagents/issues/3782)) ([f98fb0c](https://github.com/navono/deepagents/commit/f98fb0c80d08e408a018ea33a8aa7144180f4e93))
* **code:** persist `_context_tokens` via `after_model` middleware ([#3496](https://github.com/navono/deepagents/issues/3496)) ([e2bb284](https://github.com/navono/deepagents/commit/e2bb284e506e0e49a05169fc6de01bdf42350267))
* **code:** pluralize singular MCP login splash text ([#3689](https://github.com/navono/deepagents/issues/3689)) ([492b0fc](https://github.com/navono/deepagents/commit/492b0fc9209e13cd7004a255ef67b31b7e78e95e))
* **code:** point MCP re-enable guidance at `Ctrl+R` ([#3688](https://github.com/navono/deepagents/issues/3688)) ([15ca302](https://github.com/navono/deepagents/commit/15ca3029f18fa38c1592859febc2a6d0469bff2d))
* **code:** polish MCP auth success UX ([#3614](https://github.com/navono/deepagents/issues/3614)) ([d225cb4](https://github.com/navono/deepagents/commit/d225cb41f41a0a9b2876aff2443eaa0ada24bf29))
* **code:** preserve extras during install ([#3707](https://github.com/navono/deepagents/issues/3707)) ([e636ce9](https://github.com/navono/deepagents/commit/e636ce9e979fd1c30335ec340acdabbd0a5ae79e))
* **code:** preserve inherited `PYTHONPATH` for server subprocess ([#3833](https://github.com/navono/deepagents/issues/3833)) ([4689569](https://github.com/navono/deepagents/commit/4689569f94138987319cd9cbb45ce66a1f496934))
* **code:** preserve MCP token refresh when metadata discovery fails ([#3685](https://github.com/navono/deepagents/issues/3685)) ([afafeeb](https://github.com/navono/deepagents/commit/afafeeb471c4008d4eb4263ec478cf868833fe0b))
* **code:** prevent duplicate-id crash on MCP reconnect and clipboard `NoScreen` ([#3632](https://github.com/navono/deepagents/issues/3632)) ([6b9a3c0](https://github.com/navono/deepagents/commit/6b9a3c051586c26c542e958849e952d08a4b5a88))
* **code:** propagate runtime model switches to subagents ([#3771](https://github.com/navono/deepagents/issues/3771)) ([f577182](https://github.com/navono/deepagents/commit/f577182c84746e625b65c3c2fda95f8ca21164cf))
* **code:** quiet uv installer output and require Xcode CLT on macOS ([#4180](https://github.com/navono/deepagents/issues/4180)) ([785c8d0](https://github.com/navono/deepagents/commit/785c8d0061114f8f3c457d4afc35a83bd405fc1b))
* **code:** read `LANGSMITH_PROJECT` for `tracing.langsmith_project` + show default ([#4054](https://github.com/navono/deepagents/issues/4054)) ([fec1551](https://github.com/navono/deepagents/commit/fec1551e901a4fe88bd74ee4833a91ef93b1e93f))
* **code:** reconstruct message counts for `DeltaChannel` threads from writes table ([#3668](https://github.com/navono/deepagents/issues/3668)) ([27e1940](https://github.com/navono/deepagents/commit/27e1940a924abfc999126cf46024003f453ba0c8))
* **code:** recover from tool errors instead of aborting run ([#3804](https://github.com/navono/deepagents/issues/3804)) ([45691c5](https://github.com/navono/deepagents/commit/45691c556105e171c7210c7c10388dc73202a025))
* **code:** recover initial session prompts from writes table ([#3535](https://github.com/navono/deepagents/issues/3535)) ([46b6f3f](https://github.com/navono/deepagents/commit/46b6f3f3e6ce880cd5ec9cf59622bb745d6ac2eb))
* **code:** reduce OAuth login modal noise ([#3693](https://github.com/navono/deepagents/issues/3693)) ([0e8a780](https://github.com/navono/deepagents/commit/0e8a780e2dfea2e22ac44545a16279dbe30eb8ee))
* **code:** refocus `/mcp` filter input after in-place refresh ([#4080](https://github.com/navono/deepagents/issues/4080)) ([d79cd74](https://github.com/navono/deepagents/commit/d79cd74cb8a44c300c3bbad712fe77e709f9221a))
* **code:** refresh MCP OAuth tokens on restart ([#3509](https://github.com/navono/deepagents/issues/3509)) ([8919b3f](https://github.com/navono/deepagents/commit/8919b3f78c736108b5446b0ff8992a96d6965ac6))
* **code:** refresh status bar model after recovering from failed startup ([#3511](https://github.com/navono/deepagents/issues/3511)) ([c96f822](https://github.com/navono/deepagents/commit/c96f822de187431404d093b852c4a855d3ab8d30))
* **code:** remove transient `Restarting server...` message after restart ([#4047](https://github.com/navono/deepagents/issues/4047)) ([87cc504](https://github.com/navono/deepagents/commit/87cc50428bc96ef11dfb11cee4020bff322a7216))
* **code:** rename stale usage commands ([#3460](https://github.com/navono/deepagents/issues/3460)) ([da43b7f](https://github.com/navono/deepagents/commit/da43b7f9d913e6190ff03c496a269faf08bbf182))
* **code:** render MCP tool errors and drop empty-string optional params ([#3624](https://github.com/navono/deepagents/issues/3624)) ([fdf3db4](https://github.com/navono/deepagents/commit/fdf3db464cd9f3de4e84c246547dd2971d26c726))
* **code:** repair MCP OAuth login redirect and stale client registration ([#3692](https://github.com/navono/deepagents/issues/3692)) ([f741293](https://github.com/navono/deepagents/commit/f741293524f7d47eb8a16a3cd4def336c3c3c13f))
* **code:** report same-version dependency updates ([#4146](https://github.com/navono/deepagents/issues/4146)) ([156e118](https://github.com/navono/deepagents/commit/156e1185242a19746f8c268904637c73f07b9a10))
* **code:** rescaffold server workspace on `/restart` when config is missing ([#4050](https://github.com/navono/deepagents/issues/4050)) ([de51b0e](https://github.com/navono/deepagents/commit/de51b0e082293f5f795d96d3bf717c82efb9337e))
* **code:** resolve interpreter PTC allowlist against the runtime tool registry ([#3845](https://github.com/navono/deepagents/issues/3845)) ([c59a27e](https://github.com/navono/deepagents/commit/c59a27ef2405b8e04c4351ce7ffa53d8d16d519c))
* **code:** respect line width in tool output previews ([#3646](https://github.com/navono/deepagents/issues/3646)) ([ba1ad2d](https://github.com/navono/deepagents/commit/ba1ad2dbabd19b3821490537465a3bcd39c6fed6))
* **code:** restore resumed thread model ([#3651](https://github.com/navono/deepagents/issues/3651)) ([550a8ab](https://github.com/navono/deepagents/commit/550a8abf3c595d738162a97f694b5d9527613323))
* **code:** reuse persisted DCR loopback port across OAuth launches ([#3613](https://github.com/navono/deepagents/issues/3613)) ([f2f7471](https://github.com/navono/deepagents/commit/f2f747104945ac79b68e6524d6da886f7cfeb1b0))
* **code:** run auto-update before startup ([#3784](https://github.com/navono/deepagents/issues/3784)) ([c160ea3](https://github.com/navono/deepagents/commit/c160ea3eeda1d0ba707bb524cfd0ce087a854e08))
* **code:** scope `@` file completion to current cwd ([#3874](https://github.com/navono/deepagents/issues/3874)) ([dd237ac](https://github.com/navono/deepagents/commit/dd237acd21a39e98e37bb9d98dfae09bc44d5457))
* **code:** search all models from `/model` filter ([#3690](https://github.com/navono/deepagents/issues/3690)) ([5fcb877](https://github.com/navono/deepagents/commit/5fcb877d094c4504f671bb7aeb52efa7bf3a5b48))
* **code:** serialize `QueuedUserMessage` as user input ([#3708](https://github.com/navono/deepagents/issues/3708)) ([307d598](https://github.com/navono/deepagents/commit/307d59826da9b1ddcbcdab8dccef6d18ecf16d10))
* **code:** serialize cold SDK imports ([#3712](https://github.com/navono/deepagents/issues/3712)) ([fb2adc0](https://github.com/navono/deepagents/commit/fb2adc0585e978b12646602ba922e252abf41f81))
* **code:** set dcode agent names in trace metadata ([#3901](https://github.com/navono/deepagents/issues/3901)) ([ac94dd6](https://github.com/navono/deepagents/commit/ac94dd6b139211187cad8685c1152f02c51ba086))
* **code:** show "Loading..." in `/threads` agent dropdown while loading ([#4101](https://github.com/navono/deepagents/issues/4101)) ([c2d949e](https://github.com/navono/deepagents/commit/c2d949e8765fbbbdb81e5a70125932842358099f))
* **code:** show `/restart` feedback ([#3808](https://github.com/navono/deepagents/issues/3808)) ([c40bef9](https://github.com/navono/deepagents/commit/c40bef9b2aaace3909593503b28e8b548bc20014))
* **code:** show tool call previews during batched HITL approvals ([#3530](https://github.com/navono/deepagents/issues/3530)) ([84daa1a](https://github.com/navono/deepagents/commit/84daa1a2e27963a6d7694dc9278de83782b4a7b7))
* **code:** skip startup auto-update when already updated in-session ([#3915](https://github.com/navono/deepagents/issues/3915)) ([3ba3471](https://github.com/navono/deepagents/commit/3ba347138ac61a474bad58365fdeaa0d00cc1a42))
* **code:** skip tool interrupts once auto-approve is set ([#4092](https://github.com/navono/deepagents/issues/4092)) ([9e21c34](https://github.com/navono/deepagents/commit/9e21c346a6eb8ad25b9cc671f24527b07732e2b7))
* **code:** skip update prompts for editable installs ([#3781](https://github.com/navono/deepagents/issues/3781)) ([ae2874e](https://github.com/navono/deepagents/commit/ae2874e8ece96c04233c1a88a9da1bd7b9ee2bb2))
* **code:** standardize search previews and restart status ([#3806](https://github.com/navono/deepagents/issues/3806)) ([71a6d50](https://github.com/navono/deepagents/commit/71a6d508b21b275c0c7c6bd2e0752adfba496ea9))
* **code:** suppress interrupt-cleanup state writes from traces ([#3465](https://github.com/navono/deepagents/issues/3465)) ([319b24e](https://github.com/navono/deepagents/commit/319b24e6f179eaf56f105a6db683901c82fe95be))
* **code:** suppress model-switch defer toast on bare reconnect ([#4060](https://github.com/navono/deepagents/issues/4060)) ([60b1052](https://github.com/navono/deepagents/commit/60b10520d24c87b9c8c9d85b94cffae9e3c67c43))
* **code:** suppress stale update notices ([#3801](https://github.com/navono/deepagents/issues/3801)) ([db25241](https://github.com/navono/deepagents/commit/db252411d8ca945aca86429acb644540ec970bdb))
* **code:** surface cached MCP errors as failed tool messages ([#3829](https://github.com/navono/deepagents/issues/3829)) ([d83b428](https://github.com/navono/deepagents/commit/d83b428f7f97bc40b9219c02846c2d8b4ccac434))
* **code:** surface recommended models missing from installed provider profiles ([#4057](https://github.com/navono/deepagents/issues/4057)) ([56e0d31](https://github.com/navono/deepagents/commit/56e0d31b6c507d5a1e95c3f2058a8d3b9488a4db))
* **code:** surface untracked files in `@` completion ([#3872](https://github.com/navono/deepagents/issues/3872)) ([2bdf6ea](https://github.com/navono/deepagents/commit/2bdf6ea329c6b4c8be5f0075528e00c7ce2c1e6a))
* **code:** token-safe MCP OAuth login error handling and loopback edge cases ([#3492](https://github.com/navono/deepagents/issues/3492)) ([6199c71](https://github.com/navono/deepagents/commit/6199c71d6056a603a261b33b99ca3c421670ea4f))
* **code:** tool spinner, result formatting, and expand-hint fixes ([#3661](https://github.com/navono/deepagents/issues/3661)) ([54485a3](https://github.com/navono/deepagents/commit/54485a305854f46a6ce00ae4df51f3301c652a38))
* **code:** treat multi-line key-event pastes as one input ([#3856](https://github.com/navono/deepagents/issues/3856)) ([6bb15d4](https://github.com/navono/deepagents/commit/6bb15d4bd97bd16f47504f937c8458d1b53d9cc4))
* **code:** unblock `/remember` in server mode ([#3812](https://github.com/navono/deepagents/issues/3812)) ([12e00e1](https://github.com/navono/deepagents/commit/12e00e1a78e2d6be106147a0aa95a518be66849f))
* **code:** unblock TUI input during `/restart` ([#3826](https://github.com/navono/deepagents/issues/3826)) ([366cd81](https://github.com/navono/deepagents/commit/366cd81269e2d3891a477848b774cf51af0cefc0))
* **code:** unify auth status labels ([#3773](https://github.com/navono/deepagents/issues/3773)) ([8e743ac](https://github.com/navono/deepagents/commit/8e743ac895c4e38df8efa192501b8993d37f94a7))
* **code:** unpin uv self-updates and warn when a stale dcode shadows PATH ([#4185](https://github.com/navono/deepagents/issues/4185)) ([8ca0a18](https://github.com/navono/deepagents/commit/8ca0a185a15f800267cc057178a348fb5063df1e))
* **code:** warn on `/trace` when thread has no messages ([#4162](https://github.com/navono/deepagents/issues/4162)) ([c338fc9](https://github.com/navono/deepagents/commit/c338fc914fcd383beb4b97c13f53dfb2684f8c90))
* **code:** warn on misconfigured subagent files ([#3873](https://github.com/navono/deepagents/issues/3873)) ([f1614d6](https://github.com/navono/deepagents/commit/f1614d67827c3d4d3bd01a784f57f83a50ec3410))
* **code:** word-delete backspace parity in ask-user text area ([#4079](https://github.com/navono/deepagents/issues/4079)) ([ed3c499](https://github.com/navono/deepagents/commit/ed3c499354467bc5e8476e5c7cdf0cd5f8b6aec1))
* **sdk,code:** rename trace version metadata to `lc_versions` ([#3928](https://github.com/navono/deepagents/issues/3928)) ([27f38c5](https://github.com/navono/deepagents/commit/27f38c51f960941e102dfc2f9c0220bc16736749))
* **sdk,code:** use `file_path` kwarg in `read_file` examples ([#3630](https://github.com/navono/deepagents/issues/3630)) ([97946ee](https://github.com/navono/deepagents/commit/97946ee09eb167c63d8c07f8bb116f40cfc9603f))
* **sdk:** stable `HumanMessage` IDs across resumed threads ([#3591](https://github.com/navono/deepagents/issues/3591)) ([82c3194](https://github.com/navono/deepagents/commit/82c31947f9dc938ffc71e1cea96d162a39aec3a1))


### Performance Improvements

* **code:** cache theme colors/charset, fix `O(n^2)` tool-call streaming ([#3881](https://github.com/navono/deepagents/issues/3881)) ([9d463f5](https://github.com/navono/deepagents/commit/9d463f52fb3a4d458477982963f3d278d5362b48))


### Reverted Changes

* **code:** "add macOS keyboard shortcuts for line navigation" ([#3589](https://github.com/navono/deepagents/issues/3589)) ([73402e8](https://github.com/navono/deepagents/commit/73402e817340d1f5a643328a063129894be768e6))
