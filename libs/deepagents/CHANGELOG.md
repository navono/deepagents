...
## [0.6.12](https://github.com/navono/deepagents/compare/deepagents==0.6.11...deepagents==0.6.12) (2026-06-24)


### Features

* **quickjs:** add swarm task tool ([#3472](https://github.com/navono/deepagents/issues/3472)) ([2c28b7b](https://github.com/navono/deepagents/commit/2c28b7b8c2ac7571fc3a1f0d8d00f5697fe3e90e))
* **sdk:** `RubricMiddleware` for self-evaluated agent iteration ([#3529](https://github.com/navono/deepagents/issues/3529)) ([5b8d44d](https://github.com/navono/deepagents/commit/5b8d44d65c6ec43084687019cf00a37d730ac2fa))
* **sdk:** add interrupt mode to filesystem permissions ([#3505](https://github.com/navono/deepagents/issues/3505)) ([a090162](https://github.com/navono/deepagents/commit/a090162ea9fd950c54fac874b8a165ca770fd2dc))
* **sdk:** allow passing `state_schema` in `create_deep_agent` ([#3642](https://github.com/navono/deepagents/issues/3642)) ([37839bd](https://github.com/navono/deepagents/commit/37839bd7d67fba8c11ff0ccaaa8ac92b39609450))
* **sdk:** log when grep falls back from ripgrep ([#3593](https://github.com/navono/deepagents/issues/3593)) ([379b1ff](https://github.com/navono/deepagents/commit/379b1ffdc3ccf5da72d9f7264d531be108f0b36d))
* **sdk:** support configurable subagent response format ([#3882](https://github.com/navono/deepagents/issues/3882)) ([b0e4d7a](https://github.com/navono/deepagents/commit/b0e4d7aa8d0ad58c65bddef3835e539b3d5b2a99))
...
* **sdk:** `read_file` pagination skipping lines after wrapping ([#3641](https://github.com/navono/deepagents/issues/3641)) ([390551d](https://github.com/navono/deepagents/commit/390551d61d57ce68c2a80ed78c07eaa8e985908b))
* **sdk:** align `glob` path default with `grep` ([#3666](https://github.com/navono/deepagents/issues/3666)) ([ece8e75](https://github.com/navono/deepagents/commit/ece8e752059f493254753194bcf59befe54b3556))
* **sdk:** anchor ripgrep glob to search root ([#3454](https://github.com/navono/deepagents/issues/3454)) ([e50fa3f](https://github.com/navono/deepagents/commit/e50fa3f00ab1b1a84bbaed74bf7e89118b7c2d82))
* **sdk:** assign UUIDs to ID-less messages in _messages_delta_reducer ([#3513](https://github.com/navono/deepagents/issues/3513)) ([6d959ad](https://github.com/navono/deepagents/commit/6d959ade30655eae3967c9809994434e0bbd1148))
* **sdk:** clarify skill source labels in system prompt ([#3464](https://github.com/navono/deepagents/issues/3464)) ([fc6a24f](https://github.com/navono/deepagents/commit/fc6a24f18829cf3f36089945226edfa50d52ab9e))
* **sdk:** compare provider in `model_matches_spec` ([#3943](https://github.com/navono/deepagents/issues/3943)) ([34244b6](https://github.com/navono/deepagents/commit/34244b6aebde4c237758dacedccdc3e22f3ca8e5))
* **sdk:** don't swallow `TypeError` from custom `token_counter` ([#3927](https://github.com/navono/deepagents/issues/3927)) ([a6ec9d0](https://github.com/navono/deepagents/commit/a6ec9d0e797a8b8a7d53d7debb197bb25e80be41))
* **sdk:** export `DeepAgentState` ([#3653](https://github.com/navono/deepagents/issues/3653)) ([14a9047](https://github.com/navono/deepagents/commit/14a904757c2d9d797945b6ea1bc9529f1f8cf369))
* **sdk:** grep crashing when files vanish mid-walk ([#3592](https://github.com/navono/deepagents/issues/3592)) ([0b8301b](https://github.com/navono/deepagents/commit/0b8301b2067f7dbbc83ebcf05c52e91413260fd1))
* **sdk:** guard empty binary reads with empty-content warning ([#3675](https://github.com/navono/deepagents/issues/3675)) ([2c2cec8](https://github.com/navono/deepagents/commit/2c2cec87476f06e32c7b09cedd2c44e0c713f147))
* **sdk:** handle `None` state in messages delta reducer ([#3636](https://github.com/navono/deepagents/issues/3636)) ([5a6d920](https://github.com/navono/deepagents/commit/5a6d920d9dec2199cbe743062a5cc1ff8f298567))
* **sdk:** handle `Overwrite`-wrapped messages in tool result interception ([#3905](https://github.com/navono/deepagents/issues/3905)) ([a043c5a](https://github.com/navono/deepagents/commit/a043c5a6717374c405a3ed740cfdafdd196f5f21))
* **sdk:** handle base64 reads with unknown file extensions ([#3663](https://github.com/navono/deepagents/issues/3663)) ([9857a08](https://github.com/navono/deepagents/commit/9857a08b6144b2f001d8f4bf03ac2f254c6b2da4))
* **sdk:** keep private state out of subagent propagation ([#3542](https://github.com/navono/deepagents/issues/3542)) ([7ff9553](https://github.com/navono/deepagents/commit/7ff9553fc057a682ba503ebfe9a870adb51ab848))
* **sdk:** make sync glob timeout bound wall-clock time ([#3866](https://github.com/navono/deepagents/issues/3866)) ([cba6caf](https://github.com/navono/deepagents/commit/cba6caf8f708133381506ecc9e217e7e3ca1c7f2))
* **sdk:** normalize read slices after windowing ([#3888](https://github.com/navono/deepagents/issues/3888)) ([33d900c](https://github.com/navono/deepagents/commit/33d900c98b686aa7e7782d0be3019010ced5f03a))
* **sdk:** pass through summarization factory prompt knobs ([#3559](https://github.com/navono/deepagents/issues/3559)) ([a663cad](https://github.com/navono/deepagents/commit/a663cad8858a78a5d063af0c51bb789bfb1aba2b))
* **sdk:** preserve media references in summarization archives ([#3990](https://github.com/navono/deepagents/issues/3990)) ([2d6fb53](https://github.com/navono/deepagents/commit/2d6fb53cd8c94680a42fa9d7041509ff78050616))
* **sdk:** propagate goto and graph in Commands returned by tools ([#3391](https://github.com/navono/deepagents/issues/3391)) ([d92aef6](https://github.com/navono/deepagents/commit/d92aef68f70a5e5277c43a50581e7895e682c417))
* **sdk:** return grep errors for sandbox exec failures ([#3637](https://github.com/navono/deepagents/issues/3637)) ([f87d61f](https://github.com/navono/deepagents/commit/f87d61f01a23fcfb994e88b7f9324d404e66faef))
* **sdk:** route `BaseSandbox async` helpers through aexecute ([#3996](https://github.com/navono/deepagents/issues/3996)) ([52dcf1a](https://github.com/navono/deepagents/commit/52dcf1a42cb00dd614b336038e4398472f78859d))
...
* **sdk:** stream Python grep fallback ([#3886](https://github.com/navono/deepagents/issues/3886)) ([3673d95](https://github.com/navono/deepagents/commit/3673d95d41aa00f03fbfe2083e46afa485800f3a))
* **sdk:** strip HTML comments from memory content before system prompt injection ([#3462](https://github.com/navono/deepagents/issues/3462)) ([bfbb8bc](https://github.com/navono/deepagents/commit/bfbb8bc5575ebd1ba9aa29430f6d2f86c24b7d3c))
* **sdk:** summarization: truncate trailing ToolMessages to keep context within `keep` limit ([#3405](https://github.com/navono/deepagents/issues/3405)) ([bee514f](https://github.com/navono/deepagents/commit/bee514fd24862b6b22a5993eb8b6cfc69e42dd80))
* **sdk:** surface missing path errors in `FilesystemBackend.ls` ([#3574](https://github.com/navono/deepagents/issues/3574)) ([4c28760](https://github.com/navono/deepagents/commit/4c28760abbbe43117f2118793f11ff9d4f71761e))
* **sdk:** timeout python grep fallback ([#1937](https://github.com/navono/deepagents/issues/1937)) ([665a18e](https://github.com/navono/deepagents/commit/665a18e7fe7f291319af6780328384cc658af899))


### Performance Improvements

* **sdk:** cache filesystem system prompts ([#3889](https://github.com/navono/deepagents/issues/3889)) ([2f432ba](https://github.com/navono/deepagents/commit/2f432ba63687d7c8488d5d41d0551d02b4ae00b4))
* **sdk:** cache grep glob matchers ([#3887](https://github.com/navono/deepagents/issues/3887)) ([eae3cf1](https://github.com/navono/deepagents/commit/eae3cf148de3f8c8ee9ffd8af6e5a5e06cce9d6f))
* **sdk:** count tokens once per model call in summarization middleware ([#3877](https://github.com/navono/deepagents/issues/3877)) ([6558c8c](https://github.com/navono/deepagents/commit/6558c8ca3d8e10e3309f95c807e740914af3175f))
